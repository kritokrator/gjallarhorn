...
if __name__ == '__main__':
    ...
    # uncomment this if you want to download all data directly from last.fm
    #result = last_fm_downloader.get_all_tracks()

    #  uncomment this if you want to read the data from a previously created json file with last.fm data
